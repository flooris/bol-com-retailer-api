 ...
 * @method null|string getCampaignName()
 ...
 */
final class CampaignPerformance extends AModel
{
	/**
	...
	/**
	 * The value of sales in EUR of similar products with a different EAN up to 14 days after a visitor viewed the ad, with two
	...
	/**
	 * The amount spent on the campaign in EUR, with two decimals of precision.
	 * @var float
	 */
	...
	/**
	 * The Advertising Cost of Sale is a ratio of the ad spend versus sales revenue, with four decimals of precision.
	 * @var float
	 */
	protected ?float $acos = null;

	/**
	 * The Return on Advertising Spent for the campaign is a ratio of sales revenue versus ad spend, with four decimals of
	 * precision.
	 * @var float
	 */
